...
namespace Syncr.Helpers
{
    internal static class FlickrExtensions
    {
        ...
        internal static async Task DownloadFileAsync(this Flickr flickr, StorageFolder folder, Photo photo)
        {
            ...
            using (var response = await HttpWebRequest.CreateHttp(url).GetResponseAsync())
